...
namespace EnVoitureUnitTest
{
    ...
    public class TestRoadUser
    {
        ...
        {
            RoadUser car1 = new Car(10, 20, 30, 40, 100);
        ...
        {
            RoadUser car = new Car(16, 42, 120, 910, 100);
        ...
        {
            RoadUser car = new Car(0, 0, 10, 10, 100);
            car.Angle = 42;
